...
const (
	UserService_GetUserMe_FullMethodName = "/proto.UserService/GetUserMe"
)
...
type UserServiceClient interface {
	GetUserMe(ctx context.Context, in *GetUserMeReq, opts ...grpc.CallOption) (*User, error)
}
...
func (c *userServiceClient) GetUserMe(ctx context.Context, in *GetUserMeReq, opts ...grpc.CallOption) (*User, error) {
...
type UserServiceServer interface {
	GetUserMe(context.Context, *GetUserMeReq) (*User, error)
...
func (UnimplementedUserServiceServer) GetUserMe(context.Context, *GetUserMeReq) (*User, error) {
...
func _UserService_GetUserMe_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).GetUserMe(ctx, req.(*GetUserMeReq))
	}
